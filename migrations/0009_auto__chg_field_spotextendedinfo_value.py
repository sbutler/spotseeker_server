...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpotExtendedInfo.value'
        db.alter_column('spotseeker_server_spotextedd8e', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SpotExtendedInfo.value'
        db.alter_column('spotseeker_server_spotextedd8e', 'value', self.gf('django.db.models.fields.CharField')(max_length=200))
