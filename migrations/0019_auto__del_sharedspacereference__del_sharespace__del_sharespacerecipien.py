...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spotseeker_server_sharedsp3f73', (
            ...
            ('shared_count', self.gf('django.db.models.fields.IntegerField')()),
            ('date_first_viewed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('viewed_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('spotseeker_server', ['SharedSpaceRecipient'])

        # Adding model 'SharedSpace'
        db.create_table('spotseeker_server_sharedspace', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('spotseeker_server', ['SharedSpace'])
