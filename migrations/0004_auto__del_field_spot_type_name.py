...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Spot.type_name'
        db.delete_column('spotseeker_server_spot', 'type_name')

    def backwards(self, orm):
        # Adding field 'Spot.type_name'
        db.add_column('spotseeker_server_spot', 'type_name',
