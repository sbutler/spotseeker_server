...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FavoriteSpot'
        db.create_table('spotseeker_server_favoritespot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('spot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotseeker_server.Spot'])),
        ))
        db.send_create_signal('spotseeker_server', ['FavoriteSpot'])


    def backwards(self, orm):
        # Deleting model 'FavoriteSpot'
        db.delete_table('spotseeker_server_favoritespot')
