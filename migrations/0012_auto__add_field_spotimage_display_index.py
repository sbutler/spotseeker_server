...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpotImage.display_index'
        db.add_column('spotseeker_server_spotimage', 'display_index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpotImage.display_index'
        db.delete_column('spotseeker_server_spotimage', 'display_index')
