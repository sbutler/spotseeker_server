...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrustedOAuthClient.bypasses_user_authorization'
        db.add_column('spotseeker_server_trustedoe44a', 'bypasses_user_authorization',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrustedOAuthClient.bypasses_user_authorization'
        db.delete_column('spotseeker_server_trustedoe44a', 'bypasses_user_authorization')
