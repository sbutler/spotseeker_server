...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpaceReview.original_review'
        db.add_column('spotseeker_server_spacereview', 'original_review',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'SpaceReview.is_deleted'
        db.add_column('spotseeker_server_spacereview', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpaceReview.original_review'
        db.delete_column('spotseeker_server_spacereview', 'original_review')

        # Deleting field 'SpaceReview.is_deleted'
        db.delete_column('spotseeker_server_spacereview', 'is_deleted')
