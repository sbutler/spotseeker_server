...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Spot.description'
        db.delete_column('spotseeker_server_spot', 'description')

    def backwards(self, orm):
        # Adding field 'Spot.description'
        db.add_column('spotseeker_server_spot', 'description',
