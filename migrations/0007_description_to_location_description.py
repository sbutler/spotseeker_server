...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for info in orm['spotseeker_server.SpotExtendedInfo'].objects.filter(key='description'):
            info.key = 'location_description'
            info.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for info in orm['spotseeker_server.SpotExtendedInfo'].objects.filter(key='location_description'):
